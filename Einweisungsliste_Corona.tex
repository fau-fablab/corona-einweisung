...
\fancyfoot[L]{Einweisungsliste Nr.  Corona  \underline{\hspace{3em}}}

\begin{document}
%\maketitle
Ich bestätige mit meiner Unterschrift verbindlich, dass ich die Unterweisung zur \emph{Betriebsanweisung zum Schutz vor einer Infektion durch Coronavirus SARS-CoV-2} im \emph{FAU FabLab}
\begin{itemize}
...
\begin{tabularx}{\textwidth}{|l|l|X|X|}
  \hline
  \textbf{Nr.} & \textbf{Datum} & \textbf{Name} & \textbf{Unterschrift} \\ \hline
  \whiledo{\value{i}<14}%
  {%
